public class burritobowl {
    burritobowl(String rice,String protein, String [] toppings, boolean doubleProtein){
        rice = " ";
        protein = " ";
    ...
    public void addRice(String x){
        ...
        if(y.contains("white")){
        y="white";
        System.out.println("Ok, White Rice, what beans would you like on your burrito bowl");
        
        }
        else if(y.contains("brown rice")){
        y="brown rice";
        System.out.println("Ok,Brown Rice, What beans would you like on your burrito bowl");
      
        }
        else if(y.contains("brown") && y.contains("white")){
        y="Brown and White rice";
        System.out.println("Ok, both rices, What beans would you like on your burrito bowl");
        
        }
        else if(y.contains("no")){
        y="No rice";
        System.out.println("Ok, No rice, What beans would you like on your burrito bowl");
    ...
    public void addBeans(String x){
        ...
        if(a.contains("black")&& a.contains("pinto")){
         System.out.println("Ok, Both types of beans, what protein would you like on your burrito bowl");
    
        }
        else if(a.contains("pinto")){
            System.out.println("Ok, Pinto beans, what protein would you like on your burrito bowl");
        }
        else if(a.contains("black")){
        System.out.println("Ok, Black beans, what protien would you like on your burrito bowl");  
        
        }
        else if(a.contains("no")){
            System.out.println("Ok, no beans, what protein would you like on your burrito bowl");
        }
    }
    }
